exp = "exp040"
model_name = "cascade_rcnn_effb3_fpn_20e_coco"
cv = "0"

_base_ = "/workspace/customized_mmdetection/configs/effnet/cascade_rcnn_effnet_fpn_20e_coco.py"
...
neck_in_channel = [32,48,136,384]
neck_out_channel = 160
...
model = dict(
    ...
    neck=dict(
        type='FPN',
        in_channels=neck_in_channel,
        out_channels=neck_out_channel,
        num_outs=5),
    rpn_head=dict(
        type='RPNHead',
        in_channels=neck_out_channel,
        feat_channels=neck_out_channel,
