...
class CustomDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        aug = self.transform_resize(image=images, mask=bbox_mask)
...
def get_train_transforms(image_size):
    ...
    #     albumentations.GridDistortion(num_steps=2, distort_limit=1.),
    # ], p=0.75),

    albumentations.HueSaturationValue(hue_shift_limit=40, sat_shift_limit=40, val_shift_limit=0, p=0.75),
    # albumentations.ShiftScaleRotate(shift_limit=0.2, scale_limit=0.3, rotate_limit=30, border_mode=0, p=0.75),
    albumentations.ShiftScaleRotate(shift_limit=0.0, scale_limit=0.2, rotate_limit=15, border_mode=0, p=0.75),
