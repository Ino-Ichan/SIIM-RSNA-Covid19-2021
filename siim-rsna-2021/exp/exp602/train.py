...
class Net(nn.Module):
    def __init__(self, name="resnest101e"):
        ...
        self.b1 = model.stages[0]
        self.b2 = model.stages[1]
        self.b3 = model.stages[2]
        self.b4 = model.stages[3]

        self.b5 = model.final_conv
        self.b6 = model.final_act

        self.global_pool = model.head.global_pool
        self.dropout = nn.Dropout(0.5)
        self.myfc = nn.Linear(model.head.fc.in_features, len(target_columns))
