...
do
    python test.py --img 512 --batch 32 --exist-ok\
     ...
     --weights /workspace/output/yolo_$exp\_cv$cv/weights/best.pt  /workspace/output/yolo_exp004\_cv$cv/weights/best.pt\
     --project siim_rsna_yolov5 --name /workspace/output/yolo_val_$exp\_cv$cv --augment\
